package com.yusufcancakmak.mvvmmovieapp.viewmodel
...
import com.yusufcancakmak.mvvmmovieapp.repository.TvShowRepository
...
class TvShowViewModel @Inject constructor(private val repository: TvShowRepository):ViewModel() {
    ...
    val responceTvShow:LiveData<List<TvShowItem>>
    get() = _response
